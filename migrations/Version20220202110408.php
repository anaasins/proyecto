 ...
 */
final class Version20220202110408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entrenamiento ADD autor_id INT NOT NULL');
